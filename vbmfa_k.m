...
function net = vbmfa(Y,Y_labels,num_clusters,maxdim,pcaflag,Fflag,dsp,net);
...
if nargin<5, pcaflag = 0; end
if nargin<6, Fflag = 0; end
if nargin<7, dsp = pi; end
...
birthtol = 1e-2;
removal = 0; % if on, insists removal of components that have close to zero responsibility
F = -inf;
Fhist = [];
it = 1; I = eye(k-1,k-1);
